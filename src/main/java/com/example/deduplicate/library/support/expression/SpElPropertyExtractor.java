...
/**
 * A variant of the {@link SpElKeyExtractor} which focuses on a single element of the {@code
 * Object[] source} from the {@link SpElKeyExtractor#getRootObject(Object[])} input
 *
 * <p>This class defines how the targeted argument is accessed at runtime. Specifically, storing the
